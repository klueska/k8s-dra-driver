...
// ComputeDomainManager manages compute domains for a node
...
// NewComputeDomainManager creates and initializes a new ComputeDomainManager instance
...
// TODO: move grabbing of computeDomain out of newSettings()
// TODO: bring back printing of config in addition to creating of config
// TODO: investigate why sometimes one daemon duty cycles once

// UpdateComputeDomainNodeInfo updates the node's information in the ComputeDomain
...
// GetComputeDomainNodeStatusInfo gets the node status info for a ComputeDomain
func (m *ComputeDomainManager) GetComputeDomainNodeStatusInfo(ctx context.Context, nodeName string) (*nvapi.ComputeDomainNode, error) {
	...
	n := &nvapi.ComputeDomainNode{
		...
		IPAddress: ipAddress,
		CliqueID:  m.config.cliqueID,
		Status:    nvapi.ComputeDomainNodeStatusNotReady,
	}
